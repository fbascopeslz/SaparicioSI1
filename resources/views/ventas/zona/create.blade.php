...
@section ('contenido')
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            ...
            {!!Form::open(array('url'=>'ventas/zona','method'=>'POST','autocomplete'=>'off'))!!}
            {{Form::token()}} <!---->
            <div class="form-group">
                <label for="nombre">Zona</label><!---->
                <input type="text" name="nombre" class="form-control" placeholder="Zona..."><!--name="tipo" tipo es reconocido por TBformRequest-->
