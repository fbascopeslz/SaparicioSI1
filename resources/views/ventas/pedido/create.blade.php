                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control selectpicker" name="pidProd" id="pidProd" data-Live-search="true">
                            @foreach($productos as $producto)
                                <option value="{{$producto -> idProd}}_{{$producto ->precio}}_{{$producto ->stock}}">{{$producto -> producto}}</option>
                            @endforeach
                        </select>
                    </div>
               </div>
...
<script>
    ...
    function agregar(){
        ...
        if(id_articulo != "" && cantidad != "" && cantidad > 0 && precio_venta != "" && descuento != "" )
        {
            ...
            var fila = '<tr class="selected" id="fila'+cont+'"><td><button class="btn btn-warning" type"button" onclick="eliminar('+cont+');">X</button></td><td><input type="hidden" name="idProd[]" value="'+id_articulo+'">'+articulo+'</td><td><input type="number" name="cantidad[]" value="'+cantidad+'"></td><td><input type="number" name="precio[]" value="'+precio_venta+'" readonly></td><td><input type="number" name="descuento[]" value="'+descuento+'"></td><td>'+subtotal[cont]+'</td></tr>';
